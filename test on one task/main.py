...
data_root = "C:/Users/ASUS/Desktop/one_task"
...
# Define the model architecture without initializing it
convolutional_network = resnet18(pretrained=False)
convolutional_network.fc = nn.Flatten()

# Initialize the model and load the saved weights
model = PrototypicalNetworks(convolutional_network)
model.load_state_dict(torch.load('few_shot_learning_model_all_classes.pth'))
model.eval()  # Set the model to evaluation mode


N_WAY = 16  # Number of classes in a task (bmw, acura, audi)
N_SHOT = 20  # Number of images per class in the support set
N_QUERY = 5  # Number of images per class in the query set
N_EVALUATION_TASKS = 1  # Number of evaluation tasks
